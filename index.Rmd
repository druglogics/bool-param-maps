...
```{r umap-unsup-model-num-fig, cache=TRUE, fig.cap='UMAP: Parameterization vs Numerical Model Representation'}
...
```{r umap-unsup-fig, cache=TRUE, fig.cap='UMAP: Parameterization vs Number of fixpoints'}
...
```{r umap-sup-fig, cache=TRUE, fig.cap='UMAP Supervised: Parameterization vs Number of fixpoints'}
...
```{r umap-sup-fig-2, cache=TRUE, fig.cap='UMAP Supervised: Parameterization vs Numerical Model Representation'}
...
```{r map-imp-nodes-umap-fig,cache=TRUE}
...
```{r map-less-imp-nodes-umap-fig, cache=TRUE}
...
```{r map-cflar-umap-fig, cache=TRUE}
