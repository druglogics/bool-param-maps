...
```{r state-syn-heat, cache=TRUE, fig.cap='Heatmap of Average State Differences between synergistic and antagonistic model groups for each observed synergy'}
...
```{r lo-syn-heat, cache=TRUE, fig.cap='Heatmap of Average Link Operator Differences between synergistic and antagonistic model groups for each observed synergy'}
# define coloring function of state differences
