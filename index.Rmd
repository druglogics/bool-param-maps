...
:::{.blue-box}
We draw the parameterization maps (supervised and unsupervised) for the 1 stable state models, while coloring the points/models according to the link operator value of some of the link-operator nodes that were found from the above two analyses (`emba` and random forests)
:::
